...
> [!NOTE]
> **Single Source of Truth**: For core concepts, policies, running tests, and general best practices, always refer to the project's **evals/README.md**.
...
*   *See the project's **evals/README.md** for running commands.*
