/**
 * @fileoverview Factory for creating React Native Logger instances with singleton pattern.
 */
...
/**
 * Create a React Native Logger instance.
 ...
 */
export function createReactNativeLogger(opt?: { analytics?: AnalyticsTracker }): Logger {
...
export function getLogger(): Logger {
  return singleton ?? createReactNativeLogger()
}
